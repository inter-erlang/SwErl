...
//        // This is the tearDown() local method.
...
//    }
    ...
    func testPlayWithReceive() throws{
    ...
    func testStartPeerPortsDictionary(){
        ...
        let pid = Registrar.local.processesLinkedToName["peerPorts"]
        XCTAssertNotNil(pid)
    ...
    func testSpawnProcessesFor() throws{
        ...
        var pid = Registrar.local.processesLinkedToName["clear_buffer"]
        XCTAssertNotNil(pid)//pid was stored
        XCTAssertNotNil(Registrar.local.processesLinkedToPid[pid!])//closure was stored
        
        pid = Registrar.local.processesLinkedToName[EPMDRequest.register_node]
        XCTAssertNotNil(pid)
        XCTAssertNotNil(Registrar.local.processesLinkedToPid[pid!])
        
        
        pid = Registrar.local.processesLinkedToName[EPMDRequest.port_please]
        XCTAssertNotNil(pid)
        XCTAssertNotNil(Registrar.local.processesLinkedToPid[pid!])
        
        pid = Registrar.local.processesLinkedToName[EPMDRequest.names]
        XCTAssertNotNil(pid)
        XCTAssertNotNil(Registrar.local.processesLinkedToPid[pid!])
        
        pid = Registrar.local.processesLinkedToName[EPMDRequest.kill]
        XCTAssertNotNil(pid)
        XCTAssertNotNil(Registrar.local.processesLinkedToPid[pid!])
